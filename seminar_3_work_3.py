...
def main():
    ...
    get_word_length(word, N)
def get_word_length(text, n ):
    eng = {1: 'AEIOULNSTR',
           2: 'DG',
           3: 'BCMP',
           4: 'FHVWY',
    ...
    if n == 1:
        print('За это слово вы получаете', sum([k for i in text for k, v in eng.items() if i in v]), 'очков')
    elif n == 0:
        print('За это слово вы получаете', sum([k for i in text for k, v in rus.items() if i in v]), 'очков')
    else:
